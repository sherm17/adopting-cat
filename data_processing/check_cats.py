...
def check_for_new_cats(**context):
    ...
    jellysplace_cats = context['task_instance'].xcom_pull(
        task_ids='scrape_jellys_place', key='Jellys_Place_Adoptable_Cats'
    )

    all_cats = san_fran_spca_cats + east_bay_spca_cats + jellysplace_cats
